// src/lib.rs
/*
 * Core library for HomeAssistant
 */
...
#[derive(Debug)]
pub struct HomeAssistantProcessor {
    verbose: bool,
    processed_count: usize,
}

impl HomeAssistantProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting HomeAssistant processing");
    
    let mut processor = HomeAssistantProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = HomeAssistantProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = HomeAssistantProcessor::new(false);
